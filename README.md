...
- Lead Frontend Engineer with 8+ years of experience building scalable web apps and leading cross-functional teams.
- Expert in architectural decision-making, full-stack solutions, and modern web ecosystems.

--- 

### 🏆 Expertise & Impact

- 💳 **FinTech & Payments:**  Architected and tailored robust payment systems for large-scale e-commerce.
- 🏗️ **Scalable Data Systems:**  Expert in designing high-performance DB schemas and optimized data-flow architectures.
- 🧩 **Micro-Frontend Architecture:**  Implemented complex multi-frontend structures with isolated CI/CD and preview builds.
- ⚡ **Performance:**  Reduced load times and regressions through automated performance budgets and audits.
...
![Qwik](https://img.shields.io/badge/Qwik-blueviolet?style=for-the-badge&logo=qwik)
...
![Panda CSS](https://img.shields.io/badge/Panda_CSS-F7E025?style=for-the-badge)
